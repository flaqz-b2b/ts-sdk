...
import { CampaignClient } from "./api/resources/campaign/client/Client.js";
...
export class FlaqzAppClient {
    ...
    protected _campaign: CampaignClient | undefined;
    ...
    public get campaign(): CampaignClient {
        return (this._campaign ??= new CampaignClient(this._options));
    }
}
